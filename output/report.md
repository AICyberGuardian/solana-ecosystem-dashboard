...
**Generated:** `2026-09-23T16:46:21Z` | **Health Score:** `97.0/100` (OPTIMAL) | **Zero API Keys**
...
Current network throughput stands at **5,084.7 TPS** (1-hour average: 4,969.8 TPS) with an average slot generation interval of **266.7 ms**.
Total value locked across Solana DeFi protocols totals **$6.41B** (-0.84% 24h delta), backed by **$15.93B** in on-chain stablecoin liquidity.
...
| Current Slot | `449,761,479` | N/A | Active |
| Block Height | `427,801,686` | N/A | Active |
| Current Epoch | `1041` (11.45% complete) | 432,000 slots | In Progress |
| Throughput (Current) | `5,084.7 TPS` | > 2,500 TPS | Healthy |
| Throughput (1h Peak / Min) | `6,032.2` / `4,317.1 TPS` | N/A | Measured |
| Slot Duration | `270.3 ms` | ~400.0 ms | Normal |
| Total Transactions | `551,772,545,495` | Monotonic | Active |
...
- **Total Active Stake:** 439,627,556.68 SOL
...
| :--- | :--- | :--- |
| SOL Spot Price | `$114.59` | +0.00% (Source: Coinbase) |
| Estimated Circulating Market Cap | `$67.33B` | 587.6M SOL circulating |
| 24h DEX Trading Volume | `$3.20B` | -6.82% delta |
| Total DeFi TVL | `$6.41B` | -0.84% delta |
| Circulating Stablecoins | `$15.93B` | USD: $15.86B, CAD: $1,439 |
