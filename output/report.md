...
**Generated:** `2026-09-25T10:03:08Z` | **Health Score:** `97.0/100` (OPTIMAL) | **Zero API Keys**
...
Current network throughput stands at **4,148.2 TPS** (1-hour average: 4,026.5 TPS) with an average slot generation interval of **266.4 ms**.
Total value locked across Solana DeFi protocols totals **$6.47B** (+1.17% 24h delta), backed by **$16.59B** in on-chain stablecoin liquidity.
...
| Current Slot | `450,320,061` | N/A | Active |
| Block Height | `428,359,965` | N/A | Active |
| Current Epoch | `1042` (40.75% complete) | 432,000 slots | In Progress |
| Throughput (Current) | `4,148.2 TPS` | > 2,500 TPS | Healthy |
| Throughput (1h Peak / Min) | `4,843.4` / `3,770.7 TPS` | N/A | Measured |
| Slot Duration | `264.3 ms` | ~400.0 ms | Normal |
| Total Transactions | `552,433,440,746` | Monotonic | Active |
...
| :--- | :--- | :--- |
| SOL Spot Price | `$118.03` | +0.00% (Source: Coinbase) |
| Estimated Circulating Market Cap | `$69.36B` | 587.6M SOL circulating |
| 24h DEX Trading Volume | `$2.26B` | -11.37% delta |
| Total DeFi TVL | `$6.47B` | +1.17% delta |
| Circulating Stablecoins | `$16.59B` | USD: $16.53B, CAD: $1,431 |
